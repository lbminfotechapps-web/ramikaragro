...
class DealerVisitRepositoryImpl
    implements AddDealerVisitRepository {
  final DealerVisitDataSource remoteDataSource;

  DealerVisitRepositoryImpl(
  ...
  Future<Map<String, dynamic>> addRemark(
    ...
    return remoteDataSource.addRemark(
      jsonData,
    );
  }
  ...
  Future<List<PurposeEntity>> getPurpose(
    ...
    final menus =
        await remoteDataSource.getPurpose(
      userID,
    );
  ...
  Future<Map<String, dynamic>> addDealerFollowUp(
    ...
    return remoteDataSource.addDealerFollowUp(
      jsonData,
      image,
    );
  }
  ...
  Future<Map<String, dynamic>> updateDealerFollowUp(
    ...
    return remoteDataSource.updateDealer(
      jsonData,
    );
  }
  ...
  @override
  Future<List<DealerFollowupListEntity>>
      getFollowupList(
    String outletId,
  ) async {
    final menus =
        await remoteDataSource.getFollowupList(
      outletId,
    );
