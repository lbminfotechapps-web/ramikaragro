...
class SalesWiseTargetPage extends StatefulWidget {
  const SalesWiseTargetPage({
    super.key,
  });

  @override
  State<SalesWiseTargetPage> createState() =>
      _SalesWiseTargetPageState();
}

class _SalesWiseTargetPageState
    extends State<SalesWiseTargetPage> {
  ...
  static const Color achievedColor =
      Color(0xff75B943);
  ...
  Future<void> _initialize() async {
    try {
      ...
      debugPrint(
        'SALES TARGET SCREEN USER ID: $userId',
      );
    ...
    return BlocProvider.value(
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          title:
              'Sales Wise Target And Achievement',
        ),
